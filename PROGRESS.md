...
| --- | --- | --- |
| 2026-05-21 — | _pending_ | docs(v2a): Round 2 Part 1 拍板 — 策略池 #2 選 funding rate skew(D)、calendar(C)退為 PortfolioStrategy 子訊號候選(D vs C 6 維對照:訊號 / 5-param / 資料 / M1-M7 / 失效 / vs-trend correlation 推導;C 因 N=2 樣本違反 M2/M4/M5 前提卡關)+ glossary 追加 8 詞 |
