...
| --- | --- | --- |
| 2026-05-22 — | _pending_ | docs(v2a): Round 2 #2A 拍板 — Lifecycle method 4 必 + 1 可選(__init__/required_data/initialize/on_bar 必 + reset 可選;initialize 鎖必要即使 no-op 也明寫 → contract 明確 + framework 可插 instrumentation;實際策略池 0 boilerplate 代價)+ glossary 擴 lifecycle 條目 + 5 新詞 |
