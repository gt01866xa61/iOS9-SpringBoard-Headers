...
| --- | --- | --- |
| 2026-08-09 23:46 | edacb90 | fix(web)：全站字級放大 1.5 倍，總覽改顯示同燈主題數，手機卡名／數值分列防截字 |
| 2026-08-09 23:08 | 8b2421d | feat(web)：兩個 AI 外溢主題共用 UI 區塊，17 張卡固定顯示驗證目的，記憶體四警示補共同脈絡 |
| 2026-08-02 19:54 | e57de910 | fix(web)：四條記憶體早期預警改為首屏直接可見，補 Alphabet／CXMT 一手來源與展示契約 |
...
| 2026-07-18 21:46 | e3002a1 | docs：HANDOFF.md 全面翻新交接至 Codex——13 訊號/3 cluster 現況、接力環背景、手動數據行事曆、07-18 燈況、懸決事項、push 權限（Codex 保守） |
