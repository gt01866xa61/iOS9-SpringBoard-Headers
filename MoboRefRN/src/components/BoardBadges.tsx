...
const normalStyles = StyleSheet.create({
  ...
  savedBadge: { backgroundColor: '#FDE68A', borderRadius: 6, paddingHorizontal: 6, paddingVertical: 2 },
  savedBadgeTxt: { fontSize: 10, color: '#92400E', fontWeight: '700' },
  seenBadge: { backgroundColor: '#BBF7D0', borderRadius: 6, paddingHorizontal: 6, paddingVertical: 2 },
  seenBadgeTxt: { fontSize: 10, color: '#166534', fontWeight: '700' },
...
const compactStyles = StyleSheet.create({
  ...
  savedBadge: { backgroundColor: '#FDE68A', borderRadius: 4, paddingHorizontal: 4, paddingVertical: 1 },
  savedBadgeTxt: { fontSize: 8, color: '#92400E', fontWeight: '700' },
  seenBadge: { backgroundColor: '#BBF7D0', borderRadius: 4, paddingHorizontal: 4, paddingVertical: 1 },
  seenBadgeTxt: { fontSize: 8, color: '#166534', fontWeight: '700' },
